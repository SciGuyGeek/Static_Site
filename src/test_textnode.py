...
class TestTextNode(unittest.TestCase):
    ...
    def test_split_node(self):
        ...
        self.assertEqual(new_nodes, actual_new_nodes)
    ...
    def test_text_to_textnodes_mix(self):
        text = "This is _italic_ with a **bold** word and a [link](https://boot.dev) a `code block` and an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg)"
        new_nodes = text_to_textnodes(text)
        self.assertListEqual(
            [
                TextNode("This is ", TextType.TEXT),
